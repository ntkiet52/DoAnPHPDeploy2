...
<head>
    ...
    <style>
        ...
        .btn-hero-white { background: white; color: var(--primary-blue); font-weight: bold; border-radius: 30px; padding: 10px 30px; }
        .btn-hero-outline { border: 2px solid white; color: white; font-weight: bold; border-radius: 30px; padding: 10px 30px; }
        ...
        .badge-discount { position: absolute; top: 10px; right: 10px; background: var(--dark-blue); color: white; padding: 5px 10px; border-radius: 10px; }
        .product-img { border-radius: 15px 15px 0 0; object-fit: cover; height: 180px; width: 100%; }
        .stars { color: #ffc107; font-size: 0.8rem; }
        .price-new { color: var(--dark-blue); font-weight: bold; font-size: 1.1rem; }
        .price-old { text-decoration: line-through; color: #999; font-size: 0.9rem; }
        .btn-add-cart { background: #4a6cf7; color: white; border-radius: 20px; width: 100%; font-weight: 500; }
        ...
        .bg-purple-light { background: linear-gradient(135deg, #e0c3fc 0%, #8ec5fc 100%); }
        .bg-blue-light { background: linear-gradient(135deg, #a1c4fd 0%, #c2e9fb 100%); }

        /* Features */
        .feature-box { text-align: center; padding: 20px; }
        .feature-icon-circle {
            background: #e9ecef; width: 60px; height: 60px; border-radius: 50%;
            display: flex; align-items: center; justify-content: center; margin: 0 auto 10px; color: var(--primary-blue); font-size: 1.5rem;
        }

        /* Testimonials */
        .testimonial-card { background: white; border-radius: 15px; padding: 20px; box-shadow: 0 5px 15px rgba(0,0,0,0.05); height: 100%; }
        ...
        /* Newsletter */
        .newsletter-section { background: linear-gradient(135deg, #007bff 0%, #0056b3 100%); color: white; padding: 60px 0; width: 100%; margin-left: calc(-50vw + 50%); margin-right: calc(-50vw + 50%); padding-left: calc(50vw - 50%); padding-right: calc(50vw - 50%); }
        .newsletter-section .container { max-width: 100%; padding-left: 15px !important; padding-right: 15px !important; }
        .newsletter-input { border-radius: 30px 0 0 30px; border: none; padding: 12px 20px; }
        .newsletter-btn { border-radius: 0 30px 30px 0; background: white; color: var(--primary-blue); font-weight: bold; border: none; padding: 0 25px; }
        ...
        <div class="container">
            ...
            <div class="d-flex gap-3">
                ...
                <a href="giohang.php" class="text-dark position-relative">
                    ...
                    <span data-cart-count class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-primary">0</span>
                </a>
            </div>
        </div>
    </nav>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 mb-4 mb-md-0">
                    ...
                    <p class="mb-4 opacity-75">Cung cấp đa dạng hàng hóa chất lượng, nguồn gốc rõ ràng, đáp ứng mọi nhu cầu mua sắm của bạn.</p>
                    <div class="d-flex gap-3">
                        <a href="../Login/Dangnhap.php" class="btn btn-hero-white">Mua ngay <i class="fas fa-arrow-right ms-2"></i></a>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    >
                        ...
                        <a href="<?php echo htmlspecialchars((string)($prod['link'] ?? '#'), ENT_QUOTES, 'UTF-8'); ?>" class="text-decoration-none">
                            <img src="<?php echo $prod['image']; ?>" class="card-img-top product-img" alt="<?php echo $prod['name']; ?>">
                        </a>
                        <div class="card-body">
                            ...
                            <button class="btn btn-add-cart btn-sm"><i class="fas fa-shopping-cart me-1"></i> Thêm vào giỏ</button>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="feedback-card">
                        ...
                        <p class="feedback-text">"Sản phẩm rất tươi ngon, giao hàng đúng hẹn. Tết này sẽ ủng hộ tiếp! Đóng gói rất c᪭n thận."</p>

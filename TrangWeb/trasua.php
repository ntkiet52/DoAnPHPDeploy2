...
<body>
    ...
    <?php
        ...
        if ($product === null) {
            ...
            if (count($catalog) === 0) {
                $catalog = catalogFallbackProducts();
            }
    ...
    <div class="container">
        ...
        >
            <div class="row">
                <div class="col-md-5">
                    <img src="<?php echo htmlspecialchars((string)($product['image'] ?? 'trasua.png')); ?>" alt="<?php echo htmlspecialchars($product['name']); ?>" class="main-img img-fluid">
                </div>

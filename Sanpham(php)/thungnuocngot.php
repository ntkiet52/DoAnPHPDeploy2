...
<head>
    ...
    <style>
        ...
        .verified-tag { color: #00bfa5; font-size: 12px; margin-left: 5px; }
        .review-content { color: #333; margin-top: 8px; font-size: 14px; line-height: 1.5; }

        /* FOOTER & EXTRAS (Reused styles for consistency) */
        .feature-icon-circle { width: 50px; height: 50px; background: #e7f1ff; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 10px; color: #007bff; font-size: 20px; }
        .newsletter-section { background: linear-gradient(135deg, #0099ff, #00c6ff); color: white; padding: 40px 0; margin-top: 40px; }
        footer { background: #222; color: #aaa; padding: 40px 0; font-size: 14px; }
    </style>
</head>
<body>
        ...
        <?php
        $product = [
            'name' => 'Thùng Nước Giải Khát Coca-Cola Original Taste (24 Lon x 320ml)',
            'price' => 180000,
            'old_price' => 200000,
            'sold' => '10.5k',
            'rating' => 4.9,
            'desc_list' => [
                ...
                'Thành phần: Nước bão hòa CO2, đường mía, màu thực phẩm, chất điều chỉnh độ acid, hương tự nhiên.',
                'Quy cách: Thùng 24 lon (320ml/lon)',
                'Đặc điểm: Hương vị truyền thống cực kỳ sảng khoái, ngon hơn khi uống lạnh.',
                'Hạn sử dụng: 12 tháng kể từ ngày sản xuất.'
            ]
        ];

        $reviews = [
            ['name' => 'Nguyễn Văn Nam', 'rating' => 5, 'content' => 'Giao hàng cực nhanh, thùng còn nguyên vẹn không bị móp méo. Giá rẻ hơn siêu thị.'],
            ['name' => 'Trần Thị Hoa', 'rating' => 5, 'content' => 'Coca chính hãng, date mới tinh. Sẽ ủng hộ shop dài dài!'],
            ['name' => 'Hoàng Minh', 'rating' => 4, 'content' => 'Sản phẩm tốt nhưng shipper giao hơi muộn một chút. Tổng quan vẫn rất ổn.'],
            ['name' => 'Lê Thu Thảo', 'rating' => 5, 'content' => 'Đóng gói cẩn thận, uống rất sảng khoái. Freeship nên rất tiết kiệm.']
        ];
    ?>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-3 col-6">
                    <a href="#" class="logo"><span style="color:#003366">ACK</span> <img src="https://via.placeholder.com/20/FF0000/FFFFFF?text=." style="width:10px; height:10px;" alt=""></a>
                </div>
    ...
    <div class="container">
        <div class="py-2">
            <a href="../TrangWeb/Trangdouong.php" class="text-decoration-none text-dark"><i class="fas fa-chevron-left"></i> Quay lại</a>
        </div>

        <div class="product-container">
            <div class="row">
                <div class="col-md-5">
                    <img src="../anhtrangchu/coca.png" alt="Coca" class="main-img img-fluid">
                </div>
                ...
                <div class="col-md-7">
                    ...
                    <div class="mb-2">
                        <span class="text-warning">
                            4.0 <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i>
                        </span>
            ...
            <div class="review-list">
                ...
                <div class="user-review">
                    <div class="d-flex">
                        ...
                        <div>
                            <div class="fw-bold"><?php echo $rv['name']; ?> <span class="verified-tag"><i class="fas fa-check-circle"></i> Đã mua hàng</span></div>
                ...
                <nav aria-label="Page navigation" class="mt-4 d-flex justify-content-end">
                    <ul class="pagination pagination-sm">
                        <li class="page-item"><a class="page-link text-dark" href="#"><i class="fas fa-chevron-left"></i></a></li>
    ...
    <section class="newsletter-section text-center">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-md-5">
                <div class="input-group">
                    <input type="email" class="form-control rounded-start-pill border-0 ps-4" placeholder="Nhập email của bạn...">
